  ...
  <div class="card">
    <div class="card_image-box">
      <img
        ...
        :src="data.urlToImage"
        alt=""
        class="card__image-box__image"
      />
      <div v-else class="card__image-box__noData">
        등록된 이미지가 없습니다.
      </div>
    </div>
    <div class="card_info-box">
      <div class="card_info-box_header">
        <div class="broadcast">
          ...
          <span class="broadcast_company">{{ data.author }} </span>
        </div>
...
const website = computed(() => {
  return data.value?.url?.split("https://").pop()?.split("/")[0] || "";
});
</script>
